...
[Troubleshooting](https://openafterhours.github.io/hailer/reference/troubleshooting/#troubleshooting). A missing marimo server before your first session is expected:
